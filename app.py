...
# 
# st.title("💼 AI AutoML — Income Prediction System")
# st.write("Predict whether a person earns **more than 50K** using machine learning.")
# 
# # Sidebar
# st.sidebar.header("Navigation")
# page = st.sidebar.radio("Go to:", ["🔍 Predict Income", "📊 Model Info"])
# 
# # -----------------------------
# # PAGE 1 — PREDICTION
# # -----------------------------
...
# 
#     education_num = st.slider("Education Level (1–16)", 1, 16, 12)
# 
...
# # -----------------------------
# if page == "📊 Model Info":
#     st.subheader("📊 Best Model Used: XGBoost")
# 
#     st.write("""
